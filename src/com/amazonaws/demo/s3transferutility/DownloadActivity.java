...
public class DownloadActivity extends ListActivity {
    ...
    private void beginDownload(String key) {
        ...
        // file.
        File file = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOCUMENTS + "/MicroP/")+"/"+key);
    ...
    private class DownloadListener implements TransferListener {
        ...
        public void onStateChanged(int id, TransferState state) {
            ...
            if(state == TransferState.COMPLETED) {
                Intent intent = new Intent(DownloadActivity.this, DeviceScanActivity.class);
